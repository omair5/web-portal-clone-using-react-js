...
const Header = ({ coverImage, logo, agentName, agentRating, location }) => {
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} md={8}>
                            <div className={classes.PlotForSaleContainer}>
                                ...
                                <h1>{agentName}</h1>
                                <LightTooltip title={`${agentRating} Agent`}>
                                    <img src={GenerateBadge(agentRating)} alt={agentRating} className={classes.badge} />
                                </LightTooltip>
                            </div>
                        </Grid>
                        {/* LOCATION */}
